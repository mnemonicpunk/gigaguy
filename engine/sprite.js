export default class Sprite {
    ...
    applyOptions(options) {
        ...
        if (typeof options.x_offset !== "undefined") {
            this.x_offset = options.x_offset;
        }
        if (typeof options.y_offset !== "undefined") {
            this.y_offset = options.y_offset;
        }
        ...
        if (typeof options.named_animations !== "undefined") {
            this.named_animations = options.named_animations;
        }             
    }
    _draw(ctx) {
...
export class ActorSprite extends SheetSprite {
    constructor(options) {
        super(options);

        this.named_animations = {};
    ...
    draw(ctx) {
        ...
        let anim = this.named_animations[this.current_animation];
        if (anim == undefined) {
            return;
        }

        let num = anim[this.image_number];
    ...
    setAnimation(name) {
        ...
        this.image_max = this.named_animations[name].length-1;
    }
}